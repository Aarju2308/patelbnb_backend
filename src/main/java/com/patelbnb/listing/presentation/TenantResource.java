...
import com.patelbnb.listing.application.TenantService;
...
public class TenantResource {
    ...
    public ResponseEntity<Page<DisplayCardListingDTO>> findAllByBookingCategory(Pageable pageable, @RequestParam("category") BookingCategory bookingCategory){
        return ResponseEntity.ok(tenantService.getAllByCategory(bookingCategory,pageable));
    }

    @GetMapping("/get-one")
    public ResponseEntity<DisplayListingDTO> getOne(@RequestParam("publicId") UUID publicId){
